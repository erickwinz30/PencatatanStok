                    ...
                    <div class="card bg-danger text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5">
                            ...
                            <div>
                                ...
                                <p class="text-white-50 mb-5">Masukkan barang masuk</p>

                                <form action="{{ url()->current() }}/simpan" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typeEmailX">ID Barang</label>
                                        <input type="input" name='id_barang' class="form-control form-control-lg" />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typePasswordX">Nama barang</label>
                                        <input type="input" name='nama_barang' class="form-control form-control-lg" />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typePasswordX">Nama supplier</label>
                                        <input type="input" name='supplier_barang' class="form-control form-control-lg" />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typeEmailX">Berat barang</label>
                                        <input type="input" name='berat_barang' class="form-control form-control-lg" />
                                    </div>
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typePasswordX">Jumlah barang</label>
                                        <input type="input" name='jumlah_barang' class="form-control form-control-lg" />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typePasswordX">Keterangan</label>
                                        <input type="input" name='keterangan' class="form-control form-control-lg" />
                                    </div>

                                    <div class="col text-center">
                                        <button class="btn btn-outline-light btn-lg px-5" type="submit" value="simpan">Simpan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
